...
import com.app.bus.booking.service.client.ClientService;
...
public class ClientController {
    ...
    @GetMapping("/search/{fromTown}-{toTown}")
    public ResponseEntity<?> searchAdByService(@PathVariable String fromTown, @PathVariable String toTown) {
        return ResponseEntity.ok(clientService.searchAdByFilter(fromTown, toTown));
    }
